...
public class TwitchClient {
    private static final String TOKEN = "Bearer dnk5ixmvihz7h96k4j3ih0er23y64b";
    private static final String CLIENT_ID = "ecu9bhda6veu723hkhaj0j9qr53zzv";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            ...
            try {
                // do encode because gameName may contain spaces. encode space to %20
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> {
            ...
            // convert entity to string, and then convert the string to JSONObject
            // so that we can use the member function getJSONArray() to get arrayed info under "data"
            // after that, we need to convert the JSONAarray back to string
    ...
    private List<Game> getGameList(String data) throws TwitchException {
        ...
        try {
            return Arrays.asList(mapper.readValue(data, Game[].class)); // Game[].class is Class<Game[]> as String.class is Class<String>
    ...
    public List<Game> topGames(int limit) throws TwitchException {
        ...
        return getGameList(searchTwitch(buildGameURL(TOP_GAME_URL, "", DEFAULT_GAME_LIMIT)));
    }
    ...
    private List<Item> searchStreams(String gameId, int limit) throws TwitchException {
        ...
        for (Item item : streams) {
            ...
            // Twitch stream API does not return url, so we need add url to meet the format requirements from front-end
            // twitch base url + userid is the experiment result done by Teacher
    ...
    public List<Item> searchByType(String gameId, ItemType type, int limit) throws TwitchException {
        ...
        // set gameId because some type of search do not return gameId
